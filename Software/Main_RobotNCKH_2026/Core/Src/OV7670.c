 ...
 *                               LOCAL MACRO                                  *
 ******************************************************************************/
//uint8_t cropped_buffer[CROPPED_SIZE_BYTES];
...
/* No need for buffer switching in BY_FRAME mode, keep buffer address fixed */
#define OV7670_SWITCH_BUFFER()        (OV7670.buffer_addr[0])
#define OV7670_RESET_BUFFER_ADDR()    (OV7670.buffer_addr[0])
...
#define OV7670_REG_CONTRAS             (0x40U)  /* Def: 0x40; R/W: RW; Contrast Control */
#define OV7670_REG_CONTRAS_CENTER      (0x80U)  /* Def: 0x80; R/W: RW; Contrast Center */
...
//{OV7670_REG_DBLV,             0x4a},         // PLL  x4
  ...
  /* Others */
//  {OV7670_REG_MVFP,             0x21},  //31       // Mirror flip
//  {OV7670_REG_MVFP, 0x20},
...
void OV7670_Start(void)
{
	...
	OV7670.mode = DCMI_MODE_SNAPSHOT;
	    ...
	    HAL_Delay(30);
	    HAL_DCMI_Start_DMA(OV7670.hdcmi, OV7670.mode, OV7670.buffer_addr[0], OV7670_DMA_DATA_LEN);
