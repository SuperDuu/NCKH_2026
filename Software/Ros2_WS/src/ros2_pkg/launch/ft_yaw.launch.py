...
def generate_launch_description():
    ...
    # ========================================================================
    # 2. CẤU HÌNH NVIDIA GPU (DÀNH CHO T1200 / RTX)
    # ========================================================================
    ...
    # ========================================================================
    # 4. NODE ĐIỀU KHIỂN & TRAINING (CẬP NHẬT TÊN FT_YAW)
    # ========================================================================
    ...
    # C++ Low-Level Controller (Chạy IK & Bezier)
    llc_node = Node(
        package='ros2_pkg', 
    ...
    # Python RL Trainer - Fine Tuning Yaw
    # Đã cập nhật executable thành 'ft_yaw' theo yêu cầu của bạn
    rl_train = Node(
        package='ros2_pkg', 
        executable='ft_yaw', 
        output='screen', 
