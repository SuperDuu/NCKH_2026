...
SCALE_DX = 0.04                 # ±8.0cm (Mở rộng để bước phục hồi xa hơn)
SCALE_DY = 0.02                 # ±5.0cm (Mở rộng chân bám trụ sang hai bên)
SCALE_DZ = 0.02                 # ±3.0cm (Dịch chuyển Z linh hoạt hơn)
