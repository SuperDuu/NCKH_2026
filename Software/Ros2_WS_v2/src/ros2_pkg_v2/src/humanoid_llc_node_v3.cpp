// File: src/ros2_pkg_v2/src/humanoid_llc_node_v3.cpp
// Phase 3: Humanoid LLC V3 | Identical to V2 but correctly named for Phase 3
// L3=0.08 L4=0.15 L5=0.065 | Z=0.265
...
class HumanoidIKControllerV3 : public rclcpp::Node {
public:
    ...
    HumanoidIKControllerV3() : Node("humanoid_llc_node_v3"),
        ...
        timer_ = create_wall_timer(std::chrono::milliseconds(10),
            std::bind(&HumanoidIKControllerV3::loop, this));
        RCLCPP_INFO(this->get_logger(),
            "LLC V3 (Trajectory Mode): L3=%.3f L4=%.3f L5=%.3f | Z=0.265 | Alpha=%.1f | DeadZone=%.3f",
...
int main(int argc, char **argv) {
    ...
    rclcpp::spin(std::make_shared<HumanoidIKControllerV3>());
    rclcpp::shutdown();
    return 0;
}
